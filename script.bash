...
echo ""
#
# == Executing Ingestion Part ([l/s] [dbName] [data_file_name] [log_folder])
echo "Executing IngestionMixed.jar ..."
nohup java -jar standalone/IngestionMixed.jar $1 $2 ${full_data} $folder > "logs/${folder}/extra/out__ingestion.txt" 2> "logs/${folder}/extra/err__ingestion.txt" &
#
